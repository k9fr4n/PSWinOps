...
FunctionsToExport = 'Get-NTPConfiguration', 'Get-NTPPeer', 'Get-NTPSyncStatus', 
               ...
               'Get-DnsServerHealth', 'Get-ExchangeServerHealth', 
               'Get-FileServerHealth', 'Get-HyperVHostHealth', 'Get-IISHealth', 
               'Get-PrintServerHealth', 'Get-RDSHealth', 'Get-ServiceHealth', 
               'Get-WSUSHealth', 'Connect-RdpSession', 'Disconnect-RdpSession', 
               'Get-RdpSession', 'Get-RdpSessionHistory', 'Get-RdpSessionLock', 
               'Remove-RdpSession', 'ConvertFrom-MisencodedString', 
               'New-RandomPassword', 'Get-ProxyConfiguration', 
               'Remove-ProxyConfiguration', 'Set-ProxyConfiguration', 
               'Test-ProxyConnection', 'Get-ComputerUptime', 'Get-DiskSpace', 
               ...
               'Set-PageFile', 'Clear-Arp', 'Edit-HostsFile', 'Export-NetworkConfig', 
               'Get-ARPTable', 'Get-ListeningPort', 'Get-NetworkAdapter', 
