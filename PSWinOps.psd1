...
FunctionsToExport = 'ConvertFrom-MisencodedString', 'Connect-RdpSession', 
               'Disconnect-RdpSession', 'Get-RdpSession', 'Get-RdpSessionHistory', 
               'Get-RdpSessionLock', 'Remove-RdpSession', 'Get-ComputerUptime', 
               'Get-DiskSpace', 'Get-EnvironmentVariable', 'Get-InstalledSoftware', 
               'Get-PageFileConfiguration', 'Get-PendingReboot', 
               'Get-ScheduledTaskDetail', 'Get-ServiceHealth', 'Get-StartupProgram', 
               ...
               'Test-WinRM', 'Trace-NetworkRoute', 'Get-NTPConfiguration', 
